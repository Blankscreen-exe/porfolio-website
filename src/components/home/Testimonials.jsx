                ...
                >
                    <div className="flex flex-col justify-items-center items-center h-[650px] md:h-[400px]">
                        ...
                        <div className='flex flex-col justify-between h-full'>
                          <p className='font-normal text-sm lg:text-md md:text-md sm:text-sm text-content mt-5  w-full text-center mb-8' dangerouslySetInnerHTML={{ __html: item.content }}></p>
